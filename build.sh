...
cmd buildah config \
    --annotation org.opencontainers.image.title="Ubuntu" \
    --annotation org.opencontainers.image.description="@SGSGermany's base image for containers based on Ubuntu." \
    --annotation org.opencontainers.image.url="https://github.com/SGSGermany/ubuntu" \
